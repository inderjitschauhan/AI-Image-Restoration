...
def main():
    ...
    print("\n===== DnCNN Inference Times =====")
    print("{:<30} {:<10} {:<10}".format("Model","PSNR","Time(ms)"))
    ...
    for f in os.listdir(DNCNN_DIR):
        if f.endswith(".pth"):
            ...
            print("{:<30} {:<10.2f} {:<10.2f}".format(f,psnr,t))
    ...
    print(f"DnCNN  → {psnr_dncnn:.2f}")
    print(f"Final  → {psnr_final:.2f}")

    # -------- TIME TABLE --------
    print("\n=========== INFERENCE TIME SUMMARY ===========")
    print("{:<20} {:<15}".format("Model","Time(ms)"))
    print("-"*35)
    print("{:<20} {:<15.2f}".format("Best DnCNN",best_dncnn_time))
    print("{:<20} {:<15.2f}".format("SwinIR",swin_time))
    print("{:<20} {:<15.2f}".format("Total",best_dncnn_time+swin_time))
