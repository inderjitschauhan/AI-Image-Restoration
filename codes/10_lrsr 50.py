...
if __name__ == "__main__":
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        # -------- SAVE --------
        torch.save(model.state_dict(), os.path.join(SAVE_DIR, "Dncnn_lrsr_17_Real_Last_50.pth"))

        if val_psnr_val > best_psnr:
            best_psnr = val_psnr_val
            torch.save(model.state_dict(), os.path.join(SAVE_DIR, "Dncnn_lrsr_17_Real_Best_50.pth"))
